...
<body>
    ...
    <div class="container">
        ...
        <div class="home">
            <div class="content">
			<br><br><br>
                <center><h3>Your vehicle has been added successfully</h3></center>
				<br>
				<center><h6>Now add vehicle registration, insurance and revenue certificates in drivers dashboard</h6></center>
				<br>
				<center><a href="drivers-dashboard.php"><button type="button" class="btn btn-info">Dashboard</button></a></center>
            </div>
        </div>
        <!-- Hero Section End --><br>
