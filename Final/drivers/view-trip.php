...
<body>
 ...
 <br><br>
 <h1>Trip Details of #<?php echo $tripid; ?></h1> </center>
  <br><br>
  </div>
  <div class="col-sm-2"></div>
...
if ($result->num_rows > 0) {
 ...
 <div class="col-sm-4"> 
  ...
  <center><a href="drivers-dashboard.php"><button type="button" class="btn btn-primary">←Back </button></a></center>
  
  </div>
   <div class="col-sm-4"> 

  <center><form action='accept-trip.php' method='post' > <input type='hidden' name='id' value='<?php echo$tripid ?>'><button type='submit' class='btn btn-primary '>Accept</button> </form></center>
