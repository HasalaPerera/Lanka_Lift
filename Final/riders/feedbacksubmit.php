...
$rate = $_REQUEST["demo"];
        ...
        $sql = "insert into feedback (driverid,tripid,riderid,comment,rating,type) values('$driverid','$tripid','$riderid','$comment','$rate', 'driver')";
...
<body>
    ...
    <div class="container">
        ...
        <div class="home">
            <div class="content">
			<br><br><br>
                <center><h3>Your Feedback Successully Submitted!</h3><c/enter>
				<br>
				<br>
