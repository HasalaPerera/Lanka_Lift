...
$pickuDdate = $_REQUEST["pickuDdate"];
$pickupTime= $_REQUEST["pickupTime"];
$visitingPlaces = $_REQUEST["visitingPlaces"];
$days = $_REQUEST["days"];
...
$id = $_REQUEST["id"];
 ...
 $sql = "update trips set city='$pickcity', pickup='$picklocation', pickupTime='$pickupTime', pickuDdate='$pickuDdate', visitingPlaces='$visitingPlaces', days='$days ', vehicleType='$vehicleType', dropLocation='$dropLocation', specialInstructions='$specialInstructions' where id=$id";
...
<body>
    ...
    <div class="container">
        ...
        <div class="home">
            <div class="content">
			<br><br><br>
                <center><h3>You have edited your trip</h3><c/enter>
				<br>
				<a href="riders-dashboard.php"><button type="button" class="btn btn-info">Go Back</button></a>
            </div>
        </div>
        <!-- Hero Section End --><br>
