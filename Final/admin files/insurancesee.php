...
$plateno = $_REQUEST["plateno"];
        ...
        $sql = "select vehicleInsurance from vehicles where plateno='$plateno'";
...
?>
        ...
        <div class="home">
            <div class="content">
			<br><br><br>
                <center><h3>Insurance Certificate of <?php echo$plateno ?></h3><c/enter>
				<br>
				<img src="..\drivers\images\vehicleInsurance\<?php echo$vehicleInsurance ?>">
				
				<br><br>
				<a href="admin-dashboard.php"><button type="button" class="btn btn-info">Go Back</button></a>
            </div>
        </div>
        <!-- Hero Section End --><br>
