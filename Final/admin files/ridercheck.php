...
if ($result->num_rows > 0) {
	 ...
	 echo" <h1>Rider Details of $name</h1>  </center>";
	 }else{
		 echo"<h2>Incorrect Rider ID</h2>";
}
  ...
  <div class="col-sm-2"></div>
				...
				<div class='row'>
				<center><img src='..\riders\images\<?php echo$photo?>' size='100' width='100'></center>
				<div class='col-sm-2'></div>
   <div class='col-sm-4'> <div class='mb-3 mt-3'>
    <label for='title' class='form-label'>Rider Id :</label>
 ...
 <div class='col-sm-4'>     
   <div class='mb-3 mt-3'>
    ...
    <input type='text' class='form-control' name='dropLocation'  value='<?php echo$country?>' readonly>
  </div>
