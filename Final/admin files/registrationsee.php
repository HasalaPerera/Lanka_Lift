...
$plateno = $_REQUEST["plateno"];
        ...
        $sql = "select registrationDoc from vehicles where plateno='$plateno'";
...
?>
        ...
        <div class="home">
            <div class="content">
			<br><br><br>
                <center><h3>Registration document of <?php echo$plateno ?></h3><c/enter>
				<br>
				<img src="..\drivers\images\registrationDoc\<?php echo$registrationDoc ?>">
