...
$plateno = $_REQUEST["plateno"];
        ...
        $sql = "select revenueLicense from vehicles where plateno='$plateno'";
...
?>
        ...
        <div class="home">
            <div class="content">
			<br><br><br>
                <center><h3>Revenue License of <?php echo$plateno ?></h3><c/enter>
				<br>
				<img src="..\drivers\images\revnuelicenses\<?php echo$revenueLicense ?>">
